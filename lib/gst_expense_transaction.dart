...
class GstexpenseTransaction extends StatefulWidget {
  ...
  @override
  State<GstexpenseTransaction> createState() => GstexpenseTransactionState();
}

class GstexpenseTransactionState extends State<GstexpenseTransaction> {
  List Data = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}GSTExpense_transaction.php?IT_Id=${widget.itid}&clientcode=$clientcode&cmp=$cmpcode"; // Pass username in the query
    try {
