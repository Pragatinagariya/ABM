...
class SuppAgentDetail extends StatefulWidget {
  ...
  @override
  State<SuppAgentDetail> createState() => _SuppAgentDetailState();
}

class _SuppAgentDetailState extends State<SuppAgentDetail> {
  List userData = [];
