...
class _TopCustState extends State<TopCust> {
 ...
 Future<List<Map<String, dynamic>>> fetchOrderDetails(
  ...
  Future<void> fetchTopSellingItems() async {
    String apiUrl = "${uriname}topcustomer.php?clientcode=$clientcode&cmp=$cmpcode";
                      ...
                      children: [
                            ...
                            Row(
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      expandedItemId = isExpanded ? null : customerId;
                                    });
                                  },
                                ),
                              ],
                        ...
                        if (isExpanded)
                          FutureBuilder<List<Map<String, dynamic>>>(
                            future: fetchOrderDetails(customerId, selectedFilter, startDate: startDate, endDate: endDate),
                                    ...
                                    DataColumn(
                                      label: SizedBox(
                                        ...
                                        child: Align(
                                          ...
                                          child: Text("Rate", style: TextStyle(fontSize: 10)),
                                        ),
                                      ),
                                    ),
                                  ],
                                  rows: snapshot.data!.map((order) {
                                    return DataRow(cells: [
                                      ...
                                      DataCell(SizedBox(
                                        ...
                                        child: Align(
                                          alignment: Alignment.centerRight,
                                          child: Text(order["Rate"].toString(), style: TextStyle(fontSize: 11)),
                                        ),
                                      )),
                                    ]);
                                  }).toList(),
