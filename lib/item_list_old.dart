...
//             Logger.get().log("✅ Items received: ${response_.data!.length}");
...
//             });
//           } else {
//             print('⚠️ Empty data received from server.');
//             ActivityUtil.showToast("No data found.");
//           }
//         } else {
//           // print('❌ API Manager Error: ${response.errorMessage()}');
