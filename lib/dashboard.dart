...
Future<void> fetchDropdownData() async {
  ...
  final String apiUrl =
      'http://intern.amisys.in:3000/company?clientId=${widget.clientid}';
            ...
            setState(() {
              ...
              for (var item in data) {
                ...
                if (map.containsKey('token') && map['token'] != null) {
                  // ✅ Store token with company name as key
                  globals.companyTokens[map['cmpname']] = map['token'];
                }
              ...
              if (clientMap.isNotEmpty) {
                ...
                // ✅ Set initial token based on first company
                globals.token = globals.companyTokens[dropdownValue] ?? '';
                log('Initial Token: ${globals.token}');
              }
            });
          }
        } else {
  ...
  items: clientMap.keys.map<DropdownMenuItem<String>>((String value) {
