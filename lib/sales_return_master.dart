import 'sales_return_transaction.dart';
...
class SalesReturnMaster extends StatefulWidget {
  ...
  @override
  State<SalesReturnMaster> createState() => SalesReturnMasterState();
}

class SalesReturnMasterState extends State<SalesReturnMaster> {
  List Data = [];
 ...
 Future<void> getRecord({DateTime? startDate, DateTime? endDate, String? selectedCity}) async {
    // Build the URI with applied filters
    String uri = "${uriname}sales_return_master.php?clientcode=$clientcode&cmp=$cmpcode";
              ...
              children: [
                ...
                const Column(
                  children: [
                    ...
                    Text("B", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500)),
                  ],  
                ),
                const Column(
                  children: [
                ...
                InkWell(
                  ...
                  child: const Column(
                    children: [
                      ...
                      Text("Filters", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500)),
                    ],
                  ),
                ),
              ],
                    ...
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SalesReturnTransaction(
