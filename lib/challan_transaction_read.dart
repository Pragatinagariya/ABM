...
class ChallanTransactionRead extends StatefulWidget {
  ...
  @override
  State<ChallanTransactionRead> createState() => _ChallanTransactionReadState();
}

class _ChallanTransactionReadState extends State<ChallanTransactionRead> {
  List userData = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}challan_transaction_read.php?IT_SrNo=${widget.srno}&IT_Id=${widget.itid}&clientcode=$clientcode&cmp=$cmpcode";
    try {
        ...
        if (jsonResponse is List) {
          setState(() {
            ...
            for (var data in userData) {
              ...
              _controllers
                  .add(TextEditingController(text: data["IM_ItemName"] ?? "N/A"));
              _controllers
