...
class GstexpenseTransactionRead extends StatefulWidget {
  ...
  const GstexpenseTransactionRead({
    super.key,
  ...
  @override
  State<GstexpenseTransactionRead> createState() =>
      _GstexpenseTransactionReadState();
}

class _GstexpenseTransactionReadState extends State<GstexpenseTransactionRead> {
  List userData = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}GSTExpense_transaction_read.php?IT_SrNo=${widget.srno}&IT_Id=${widget.itid}&clientcode=$clientcode&cmp=$cmpcode";
    try {
