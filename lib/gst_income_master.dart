...
import 'dart:convert';
import 'gst_income_transaction.dart';
import 'package:intl/intl.dart';
import 'package:flutter_holo_date_picker/flutter_holo_date_picker.dart';

class GstincomeMaster extends StatefulWidget {
  final String username; // Add username parameter
  final String clientcode;
  final String clientname;
  final String clientMap;
  const GstincomeMaster(
      {super.key,
  ...
  @override
  State<GstincomeMaster> createState() => GstincomeMasterState();
}

class GstincomeMasterState extends State<GstincomeMaster> {
  List Data = [];
  ...
  Future<void> getRecord(
    ...
    String uri =
        "${uriname}gst_income_master.php?clientcode=$clientcode&cmp=$cmpcode";
                        ...
                        return InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => GstincomeTransaction(
