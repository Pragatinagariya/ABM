// import 'package:ABM/purchase_return-transaction_read.dart';
import 'package:flutter/material.dart';
import 'globals.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class PurchaseReturnTransaction extends StatefulWidget {
  ...
  const PurchaseReturnTransaction({
    super.key,
  ...
  @override
  State<PurchaseReturnTransaction> createState() =>
      PurchaseReturnTransactionState();
}

class PurchaseReturnTransactionState extends State<PurchaseReturnTransaction> {
  List Data = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}purchase_return_transaction.php?IT_Id=${widget.itid}&clientcode=$clientcode&cmp=$cmpcode"; // Pass username in the query
    try {
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  onTap: () {
                    // Navigate to another page, replace 'YourNextPage' with your actual page
                    // Navigator.push(
                    //   context,
                    //   MaterialPageRoute(
                    //     builder: (context) => PurchaseReturnTransactionRead(
