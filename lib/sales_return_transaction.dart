// import 'package:ABM/sales_return_transaction_read.dart';
import 'package:flutter/material.dart';
import 'globals.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class SalesReturnTransaction extends StatefulWidget {
  ...
  @override
  State<SalesReturnTransaction> createState() => SalesReturnTransactionState();
}

class SalesReturnTransactionState extends State<SalesReturnTransaction> {
  List Data = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}sales_return_transaction.php?IT_Id=${widget.itid}&clientcode=$clientcode&cmp=$cmpcode"; // Pass username in the query
    try {
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  onTap: () {
                    ...
                    //   context,
                    //   MaterialPageRoute(
                    //     builder: (context) => SalesReturnTransactionRead(
