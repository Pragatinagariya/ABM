...
class PurchaseChallanDetails extends StatefulWidget {
  ...
  @override
  State<PurchaseChallanDetails> createState() => _PurchaseChallanDetailsState();
}

class _PurchaseChallanDetailsState extends State<PurchaseChallanDetails> {
  List userData = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}purchasechallan_transaction_read.php?IT_Id=${widget.itid}&clientcode=$clientcode&cmp=$cmpcode";
    try {
