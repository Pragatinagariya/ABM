...
class AgencyOutstandingSupplierDetail extends StatefulWidget {
  final String accid;
  ...
  const AgencyOutstandingSupplierDetail({
    super.key,
    required this.accid,
  ...
  @override
  State<AgencyOutstandingSupplierDetail> createState() =>
      _AgencyOutstandingSupplierDetailState();
}

class _AgencyOutstandingSupplierDetailState
    extends State<AgencyOutstandingSupplierDetail> {
  List userData = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}agency_outstanding_s_detail.php?d_suppid=${widget.suppid}&d_accid=${widget.accid}&clientcode=$clientcode&cmp=$cmpcode"; // Include clientcode in the URL
    try {
  ...
  Future<File> _createPDF() async {
          ...
          build: (pw.Context context) {
            return pw.Column(
              ...
              children: [
                ...
                pw.Text('Agency Outstanding Supplier',
                    style: const pw.TextStyle(fontSize: 16)),
                pw.SizedBox(height: 10),
                pw.Text('${widget.accname} -> ${widget.suppname}',
                    style: pw.TextStyle(
                ...
                pw.Text(
                    ...
                    style: pw.TextStyle(
                        fontSize: 14, fontWeight: pw.FontWeight.bold), textAlign: pw.TextAlign.right),
                pw.SizedBox(height: 10),
                pw.Divider(),
                pw.Table(
                  columnWidths: {
    ...
    final file = File('${directory.path}/agency_outstanding_supplier_detail.pdf');
  ...
  Future<void> _sharePDF() async {
    try {
      ...
      await Share.shareFiles([pdfFile.path],
          text: 'Agency Outstanding Supplier Detail PDF');
    } catch (e) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: SingleChildScrollView(
          ...
          child: Tooltip(
            message:
                '${widget.accname} -> ${widget.suppname}', // Full text in tooltip
            child: Text(
              '${widget.accname} -> ${widget.suppname}', // Correct order
