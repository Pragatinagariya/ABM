...
class SupplierList extends StatefulWidget {
  ...
  @override
  State<SupplierList> createState() => SupplierListListState();
}

class SupplierListListState extends State<SupplierList> {
  List userData = [];
  String nameFilter = '';
  List<String> Names = [];
  ...
  void initState() {
   ...
   Future<void> getRecord() async {
    String uri =
        "${uriname}supplier_list.php?clientcode=$clientcode&cmp=$cmpcode";
  ...
  return Column(
    children: [
      ...
      DropdownButton<String>(
        ...
        hint: Text('Select Supplier'), // Placeholder text
...
Future<void> _initializeDatabase() async {
 ...
 Future<void> _loadSwitchOptions() async {
  final List<Map<String, dynamic>> options = 
      await _database.query('z_settings', where: 'z_page = ?', whereArgs: ['Supplier']);
