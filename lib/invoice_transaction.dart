...
import 'dart:convert';
// import 'invoice_transaction_read.dart';
...
class InvoiceTransaction extends StatefulWidget {
  ...
  @override
  State<InvoiceTransaction> createState() => InvoiceTransactionState();
}

class InvoiceTransactionState extends State<InvoiceTransaction> {
  List Data = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}invoice_transaction.php?IT_Id=${widget.itid}&clientcode=$clientcode&cmp=$cmpcode"; // Pass username in the query
    try {
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  onTap: () {
                    ...
                    //   context,
                    //   MaterialPageRoute(
                    //     builder: (context) => InvoiceTransactionRead(
