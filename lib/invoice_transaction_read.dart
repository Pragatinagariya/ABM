...
class InvoiceTransactionRead extends StatefulWidget {
  ...
  @override
  State<InvoiceTransactionRead> createState() => _InvoiceTransactionReadState();
}

class _InvoiceTransactionReadState extends State<InvoiceTransactionRead> {
  List userData = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}invoice_transaction_read.php?IT_SrNo=${widget.srno}&IT_Id=${widget.itid}&clientcode=$clientcode&cmp=$cmpcode";
    try {
