import 'gst_expense_transaction.dart';
...
class GstexpenseMaster extends StatefulWidget {
  final String username; // Add username parameter
  final String clientcode;
  final String clientname;
  final String clientMap;
  const GstexpenseMaster(
      {super.key,
  ...
  @override
  State<GstexpenseMaster> createState() => GstexpenseMasterState();
}

class GstexpenseMasterState extends State<GstexpenseMaster> {
  List Data = [];
  ...
  Future<void> getRecord(
    ...
    String uri =
        "${uriname}gst_expense_master.php?clientcode=$clientcode&cmp=$cmpcode";
                        ...
                        return InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => GstexpenseTransaction(
