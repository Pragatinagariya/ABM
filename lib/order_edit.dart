...
Future<void> fetchOrderDetails() async {
  final url =
      '${globals.uriname}order_list_2.php?om_id=${widget.omid}&username=${widget.username}&clientcode=${widget.clientcode}';
...
Future<void> updateOrderData() async {
  ...
  Future<void> fetchCustomers() async {
    uri =
        "${globals.uriname}customer_list.php?clientcode=${widget.clientcode}&username=${widget.username}";
    try {
  ...
  Future<void> fetchAgents() async {
    uri =
        "${globals.uriname}Agent_Name.php?clientcode=${widget.clientcode}&username=${widget.username}";
    try {
      final response = await http.get(Uri.parse(uri));
      if (response.statusCode == 200) {
        setState(() {
  ...
  Future<void> fetchTransports() async {
    uri =
        "${globals.uriname}transport_list.php?clientcode=${widget.clientcode}&username=${widget.username}";
    try {
      final response = await http.get(Uri.parse(uri));
      if (response.statusCode == 200) {
