...
class HsnReadState extends State<HsnRead> {
  ...
  Future<void> _loadSwitchOptions() async {
    final List<Map<String, dynamic>> options = await _database
        .query('z_settings', where: 'z_page = ?', whereArgs: ['HSN']);
    if (options.isEmpty) {
