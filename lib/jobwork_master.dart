import 'jobwork_transaction.dart';
...
class JobworkMaster extends StatefulWidget {
  ...
  @override
  State<JobworkMaster> createState() => JobworkMasterState();
}

class JobworkMasterState extends State<JobworkMaster> {
  List Data = [];
  ...
  Future<void> getRecord(
    ...
    String uri =
        "${uriname}jobwork_master.php?clientcode=$clientcode&cmp=$cmpcode";
                        ...
                        return InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => JobworkTransaction(
