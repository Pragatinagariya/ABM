// import 'package:ABM/jobwork_transaction_read.dart';
import 'package:flutter/material.dart';
import 'globals.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class JobworkTransaction extends StatefulWidget {
  ...
  @override
  State<JobworkTransaction> createState() => JobworkTransactionState();
}

class JobworkTransactionState extends State<JobworkTransaction> {
  List Data = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}jobwork_transaction.php?IT_Id=${widget.itid}&clientcode=$clientcode&cmp=$cmpcode"; // Pass username in the query
    try {
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  onTap: () {
                    ...
                    //   context,
                    //   MaterialPageRoute(
                    //     builder: (context) => JobworkTransactionRead(
