...
class JobworkTransactionRead extends StatefulWidget {
  ...
  @override
  State<JobworkTransactionRead> createState() => _JobworkTransactionReadState();
}

class _JobworkTransactionReadState extends State<JobworkTransactionRead> {
  List userData = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}jobwork_transaction_read.php?IT_SrNo=${widget.srno}&IT_Id=${widget.itid}&clientcode=$clientcode&cmp=$cmpcode";
    try {
