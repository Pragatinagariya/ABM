...
class _OutstandingDetailScreenState extends State<OutstandingDetailScreen> {
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}outstanding_cust_detail.php?accid=${widget.accid}&clientcode=$clientcode&cmp=$cmpcode"; // Include clientcode in the URL
    try {
  ...
  //             pw.Text('Outstanding Customer', style: const pw.TextStyle(fontSize: 16)),
  ...
  //   final file = File('${directory.path}/outstanding_customer_detail.pdf');
  ...
  //         text: 'Outstanding Customer Detail PDF');
  //   } catch (e) {
