...
class _TopSellState extends State<TopSell> {
  ...
  Future<void> fetchtopsellingitems() async {
    String apiUrl =
        "${uriname}topsellling.php?clientcode=$clientcode&cmp=$cmpcode";
      ...
      body: topsellingitems.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final String itemId =
                    item["itemID"].toString(); // Ensure itemID is a string
                final bool isExpanded = (expandedItemId ==
                    itemId); // Check if this item is expanded

                print(
                    "ItemID: $itemId, isExpanded: $isExpanded"); // Debugging print
                              ...
                              onPressed: () {
                                setState(() {
                                  if (isExpanded) {
                                    ...
                                    expandedItemId =
                                        itemId; // Expand the new item
                                  }
                                  print(
                                      "Toggled ItemID: $expandedItemId"); // Debugging print
                                });
                              },
                            ),
                            Text(
                                  ...
                                  rows: snapshot.data!.map((order) {
                                    return DataRow(cells: [
                                      ...
                                      DataCell(Text(
                                          ...
                                          style:
                                              TextStyle(fontSize: fontSize))),
                                      DataCell(Text(order["Rate"].toString(),
                                          style:
                                              TextStyle(fontSize: fontSize))),
                                    ]);
                                  }).toList(),
