...
import 'dart:convert';
import 'challan_transaction_read.dart';

class ChallanTransaction extends StatefulWidget {
  ...
  @override
  State<ChallanTransaction> createState() => ChallanTransactionState();
}

class ChallanTransactionState extends State<ChallanTransaction> {
  List Data = [];
  ...
  Future<void> getRecord() async {
    String uri =
        "${uriname}challan_transaction.php?IT_Id=${widget.itid}&clientcode=$clientcode&cmp=$cmpcode"; // Pass username in the query
    try {
                ...
                return GestureDetector(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ChallanTransactionRead(
